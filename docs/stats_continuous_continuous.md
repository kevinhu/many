...
```python
many.stats.mat_corr(a_mat, b_mat, melt: bool, method: str)
```
...
```python
many.stats.mat_corr_nan(a_mat, b_mat, melt: bool, method: str)
```
...
```python
many.stats.mat_corr_naive(a_mat, b_mat, melt: bool, method: str, pbar=False)
```
